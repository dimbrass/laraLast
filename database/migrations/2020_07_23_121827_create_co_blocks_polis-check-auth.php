...
class CreateCoBlocksPolisCheckAuth extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('co_polis-check-auth__top', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('co_polis-check-auth__item', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('co_polis-check-auth__top');
        Schema::dropIfExists('co_polis-check-auth__item');
    }
}
